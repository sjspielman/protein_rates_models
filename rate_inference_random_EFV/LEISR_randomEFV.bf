...
LoadFunctionLibrary("libv3/models/protein/matrices/SJS.ibf");
...
function leisr.Baseline.ModelDescription(type){
    ...
    def [terms.model.efv_estimate_name] = terms.frequencies.predefined;
    def [terms.model.frequency_estimator] = "models.protein.random.frequencies";
    return def;
}
