...
/* "Fit" is performed with branch lengths constrained to the choice */
...
if (leisr.constraint_choice == "one"){
    utility.ForEachPair (leisr.initial_bl, "_key_","_value_", "
        leisr.initial_bl[key] = utility.Map (_value_, '_v2_', '{terms.fit.MLE : 0.1}');
    ");
}
if (leisr.constraint_choice == "five"){
    utility.ForEachPair (leisr.initial_bl, "_key_","_value_", "
        leisr.initial_bl[key] = utility.Map (_value_, '_v2_', '{terms.fit.MLE : 0.5}');
    ");
}
...
console.log(leisr.alignment_wide_MLES[terms.branch_length]);
exit();

